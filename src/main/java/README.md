...
# 기능 구현 사안
- [x] 자판기 보유금액 입력받기
  - [x] 예외처리 : 숫자가 아닌 값이 주어질 때
  - [x] 예외처리 : 10원 단위가 아닌 값이 주어질 때
- [x] 자판기가 보유한 동전 출력

- [] 상품명과 가격, 수량 입력받기
  - [] 예외처리: 형식에 맞지 않는 값이 들어올때
  - [] 예외처리 : 가격이 100원 이상 10원단위가 아닐때
- [x] 투입금액 입력받기
  - [x] 예외처리 : 숫자가 아닐때
- [] 투입금액 출력하기
- [] 상품 구매하기
  - [] 예외처리 : 없는 물품을 구매하려 할 때
  - [] 상품 구매가능(돈/수량 충분)->구매
  - [] 상품 구매 불가능(돈/수량 0)-> 잔돈반환
    - [] 반환가능할 때 -> 반환
    - [] 반환 불가할 때 -> 최대한 반환 후 남는 금액 동전으로 바꾸기
  -[] 잔돈 출력
---

- product 객체 : 상품명, 가격, 수량
- vendingmachine : 각 동전 개수, 
